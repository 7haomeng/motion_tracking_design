...
void odomCallback(const nav_msgs::OdometryConstPtr& odom){
    ...
    this_pose_stamped.pose.position.x = 10 * (odom->pose.pose.position.x);
    this_pose_stamped.pose.position.y = 10 * (odom->pose.pose.position.y);
    this_pose_stamped.pose.position.z = 10 * (odom->pose.pose.position.z);
